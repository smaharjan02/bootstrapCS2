...
# ]
commands = [
    "python3 driver.py -df tpch_10g.db -qr query_first_join.sql -sr 1.0 -ls 10 -bs 2000",
    "python3 driver.py -df tpch_10g.db -qr query_third_join.sql -sr 1.0 -ls 10 -bs 200",
    "python3 driver.py -df tpch_10g.db -qr query_third_join.sql -sr 1.0 -ls 10 -bs 2000",
]
